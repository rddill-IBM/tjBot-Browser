...
*/
    displayObjectValuesRecursive: function displayObjectValuesRecursive(_string, _object, _iter)
    {
 ...
 * @utility
 */
    displayObjectProperties: function displayObjectProperties(_name, _obj)
    {
 ...
 * @utility
 */
    displayObjectValues: function displayObjectValues(_string, _object)
    {
        for (let prop in _object){
 ...
 * 
 */
    getCookieValue: function getCookieValue(_cookie, _name)
    {
    var name = _name+"=";
